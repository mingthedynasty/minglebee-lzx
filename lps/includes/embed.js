...
function lzHistEmbed(wr) {
    ...
    //top.webapproot
    document.write("<div style='position:absolute;left:0px;top:0px;'><iframe src='"+ "lps/includes/h.html' name='_lzhist' frameborder='0' scrolling='no' width='22' height='0'></iframe></div>");
